...
class BaseModel(object):
  ...
  def __init__(self,
    ...
    # Quando verdadeiro ignora modelo e treinamento
  ...
  def _set_params_initializer(self,
    ...
    # extra_args: porta de flexibilidade para adição de código exrterno.
    self.single_cell_fn = None
    if extra_args:
      self.single_cell_fn = extra_args.single_cell_fn

    # Define unidade de números.
    self.num_units = hparams.num_units

    # Define camada de números,
    self.num_encoder_layers = hparams.num_encoder_layers
    self.num_decoder_layers = hparams.num_decoder_layers
    assert self.num_encoder_layers
    assert self.num_decoder_layers

    # Define camada de números residuais
  ...
  def _set_train_or_infer(self, res, reverse_target_vocab_table, hparams):
    """Define treinamento e interferência."""
